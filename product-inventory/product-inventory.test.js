/*const productInventory = require('./product-inventory');
const calculateDiscount = require('./product-inventory');*/
const { calculateDiscount, filterProducts, sortInventory } = require('./product-inventory');
...
/*describe("calculateDiscount", function(){
    test("should apply a 10% discount", function(){

        expect(productInventory.calculateDiscount(100, 0.1)).toBe(90);
    });
});*/
...
describe("calculateDiscount", () => {
  ...
  describe("positive cases", () => {
    test("applies 10% discount to $29.99", () => {
      expect(calculateDiscount(29.99, 0.10)).toBe(26.99);
    });
